...
<html>
  <head>
	...
	<style>
		...
		.button{height:50px; width:290px; margin:0 auto;  background:#ECF4FF;color:#5A5A5A;margin:5px auto;color:#8A8686;}
		.button span{display:block; height:100%; width:100%; text-align:center; line-height:50px; background:#ECF4FF;color:#5A5A5A;}
		.detail{height:150px; width:290px; margin:0 0 0 5px;  }
		.detail span{display:inline-block; height:30px; width:100px;  text-align:center; background:#ECF4FF;color:#5A5A5A; line-height:30px;margin:10px 0;}
